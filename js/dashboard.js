                ...
                <div class="lg:col-span-3 space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="bg-white p-6 rounded-lg shadow-md">
                            <h3 class="text-sm font-medium text-slate-500">Total Balance</h3>
                        ...
                        <div class="bg-white p-6 rounded-lg shadow-md">
                            <h3 class="text-sm font-medium text-slate-500">${currentMonthName} Income</h3>
                            <p class="text-3xl font-bold mt-1 text-green-500">${App.formatCurrency(income)}</p>
                        </div>
                        <div class="bg-white p-6 rounded-lg shadow-md">
                            <h3 class="text-sm font-medium text-slate-500">${currentMonthName} Expenses</h3>
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-md">
                        ...
                        <form id="quick-add-expense-form">
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                                <div>
                                    <label for="quick-date" class="block text-sm font-medium text-slate-600">Date</label>
                                    <input type="date" id="quick-date" value="${new Date().toISOString().split('T')[0]}" required class="mt-1 block w-full bg-slate-50 border border-slate-300 rounded-md shadow-sm p-2">
                                </div>
                                <div>
                                    <label for="quick-amount" class="block text-sm font-medium text-slate-600">Amount</label>
                                    <input type="number" id="quick-amount" step="0.01" required class="mt-1 block w-full bg-slate-50 border border-slate-300 rounded-md shadow-sm p-2">
                                </div>
                                <div>
                                    <label for="quick-category" class="block text-sm font-medium text-slate-600">Category</label>
                                    <select id="quick-category" required class="mt-1 block w-full bg-slate-50 border border-slate-300 rounded-md shadow-sm p-2">
                                        ${App.getCategoryOptions()}
                                    </select>
                                </div>
                                <div>
                                    <label for="quick-account" class="block text-sm font-medium text-slate-600">Source</label>
                                    <select id="quick-account" required class="mt-1 block w-full bg-slate-50 border border-slate-300 rounded-md shadow-sm p-2">
                                        ${App.getAccountOptions()}
                                    </select>
                                </div>
                                <div class="md:col-span-4">
                                    <label for="quick-description" class="block text-sm font-medium text-slate-600">Description</label>
                                    <input type="text" id="quick-description" class="mt-1 block w-full bg-slate-50 border border-slate-300 rounded-md shadow-sm p-2">
                                </div>
                            </div>
                            <div class="flex items-center mt-4">
                                ...
                                <label for="quick-recurring" class="ml-2 block text-sm text-slate-900">Recurring Expense</label>
                            </div>
